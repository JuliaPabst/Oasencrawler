...
void handleField(Game& game) {
    ...
    case danger:{
        ...
        if(attribute == 0){
            ...
            cout << "Gefahr! Du musst deine Geschwindigkeit beweisen! Du hast aktuell eine Geschwindigkeit von: " << game.attributes.strength << endl;
            if(game.artefacts.spinach > 0){
                cout << "Zudem hast du so viele Dosen Red Bull, die dir jeweils einen Geschwindigkeitsboost von einem Punkt geben: " << game.artefacts.spinach << endl;
            }
